...
module.exports = {
    ...
    generateSentence: generateSentence = (inhabitant, planet, spaceThing) => {
        const sentences = [
            ...
            `Look, ${getArticle(inhabitant) + " " + inhabitant}, ${getArticle(planet) + " " + planet} and ${getArticle(spaceThing) + " " + spaceThing} are trying their best! We are all part of a big intergalactic family.`,
            ...
            `If you look up, you might see this ${inhabitant} approaching ${getArticle(planet) + " " + planet}, while ${getArticle(spaceThing) + " " + spaceThing} watches them eagerly. Yearning really is a funny thing.`,
            ...
            `Howdy, ${inhabitant} here! You are born in a location, and at first you call that home. Then your nation, your continent... My wish for you is that you grow enough to call the whole universe home.`,
            ...
            `I just imagined these ${inhabitant}, ${spaceThing} and ${planet}! Our imagination has no limits, just like the universe and the realm of possibility in what we can achieve.`,
